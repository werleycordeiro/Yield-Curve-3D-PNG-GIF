...
par(bg = "white")
persp(z=z,x=seq(1970, 2000, length.out = nrow(z)),y=c(3,6,9,12,15,18,21,24,30,36,48,60,72,84,96,108,120),col=colors[z.facet.range],xlab ="Data", ylab ="Maturidade", zlab = "Taxa",theta=40,ticktype="detailed",phi=15,expand=0.4,nticks=5)
